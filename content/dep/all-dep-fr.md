# Consolidated Data Element Profiles (FR)
...
# Profil des éléments de données: Proactive Publication - Use of Administrative Aircraft
...
| Exemple de valeur | T-2019-Q3-00001 |

### 1-2 Titre du ministre

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Title of Minister |
| Nom de la zone FR | Titre du ministre |
| ID | minister |
...
### 1-3 But du voyage (anglais)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Purpose of the trip (English) |
| Nom de la zone FR | But du voyage (anglais) |
| ID | purpose_en |
...
| Validation EN | This field must not be empty |
| Validation FR | Ce champ ne doit pas être vide |
| Exemple de valeur | To attend the 2021 G7 Leaders summit meeting. |

### 1-4 But du voyage (français)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Purpose of the trip (French) |
| Nom de la zone FR | But du voyage (français) |
| ID | purpose_fr |
...
| Validation EN | This field must not be empty |
| Validation FR | Ce champ ne doit pas être vide |
| Exemple de valeur | Participer au sommet des dirigeants G7 2021. |

### 1-5 Date du début du voyage

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Travel start date |
| Nom de la zone FR | Date du début du voyage |
| ID | start_date |
...
| Validation EN | This field must not be empty |
| Validation FR | Ce champ ne doit pas être vide |
| Exemple de valeur | 2019-11-25 |

### 1-6 Date de fin du voyage
...
| Validation EN | This field must not be empty |
| Validation FR | Ce champ ne doit pas être vide |
| Exemple de valeur | 2019-11-26 |

### 1-7 Endroit(s) visité (anglais)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Location(s) visited (English) |
| Nom de la zone FR | Endroit(s) visité (anglais) |
| ID | locations_en |
...
| Validation EN | This field must not be empty |
| Validation FR | Ce champ ne doit pas être vide |
| Exemple de valeur | London, United Kingdom; Ottawa, Ontario, Canada |

### 1-8 Endroit(s) visité (français)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Location(s) visited (French) |
| Nom de la zone FR | Endroit(s) visité (français) |
| ID | locations_fr |
...
| Validation EN | This field must not be empty |
| Validation FR | Ce champ ne doit pas être vide |
| Exemple de valeur | Londres, Royaume-Uni; Ottawa, Ontario, Canada |

### 1-9 Le nombre d’heures de vol

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Number of hours flown |
| Nom de la zone FR | Le nombre d’heures de vol |
| ID | hours |
...
| Validation EN | This field must not be empty |
| Validation FR | Ce champ ne doit pas être vide |
| Exemple de valeur | 11.5 |

### 1-10 Nom des passagers

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Passenger names |
| Nom de la zone FR | Nom des passagers |
| ID | passengers |
...
| Validation EN | This field must not be empty |
| Validation FR | Ce champ ne doit pas être vide |
| Exemple de valeur | John Smith, Martha Smith, LGen Robert Jones, Thomas Cruise |

### 1-11 Renseignements supplémentaires (anglais)
...
| Validation EN | None |
| Validation FR | None |
| Exemple de valeur | A large focus of the 2021 G7 was resolving to work together to beat COVID-19 and rebuild. |

### 1-12 Renseignements supplémentaires (français)
...
| Validation EN | None |
| Validation FR | None |
| Exemple de valeur | Un des principaux objectifs du G7 de 2021 était de travailler ensemble pour vaincre le COVID-19 et reconstruire. |


---

# Profil des éléments de données: AI Strategy Implementation Tracker
...
| Exemple de valeur | TBS-001 |

### 1-2 Période de déclaration

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Reporting Period |
...
### 1-3 Domaine Prioritaire

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Priority Area |
| Nom de la zone FR | Domaine Prioritaire |
| ID | priority_area |
...
| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Key Action |
| Nom de la zone FR | Action Clé |
| ID | key_action |
...
### 1-5 Sous-action stratégique

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Strategic sub-action |
| Nom de la zone FR | Sous-action stratégique |
| ID | sub_action |
...
| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Activity |
| Nom de la zone FR | Activité |
| ID | activity |
...
| Exemple de valeur | Provide high-performance computing (HPC) and cloud infrastructure that is available, secure, and scalable to meet the demands of AI projects. |

### 1-8 Description (français)
...
| Validation FR | Limiter le nombre de caractères, libre texte (maximum 1500 caractères). |
| Limite de caractères | 1500 |
| Exemple de valeur | Fournir une infrastructure de calcul haute performance (CHP) et d'informatique en nuage disponible, sécurisée et évolutive pour répondre aux exigences des projets d'IA. |

### 1-9 Achèvement attendu

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Expected Completion |
| Nom de la zone FR | Achèvement attendu |
...
### 1-10 Ministère(s) responsable(s)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Lead Department(s) |
| Nom de la zone FR | Ministère(s) responsable(s) |
| ID | lead_department |
...
### 1-12 Progrès réalisés (anglais)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Progress Made (English) |
| Nom de la zone FR | Progrès réalisés (anglais) |
| ID | progress_en |
...
| Validation FR | Limiter le nombre de caractères, libre texte (maximum 1500 caractères). |
| Limite de caractères | 1500 |
| Exemple de valeur | AI Strategy is being implemented using various new initiatives. The initiatives are divided into four components. The four components of this initiative as further been broken down into various activities, sub-activities, status trackability, descriptions, and progress made. Progress made is being tracked using: In Progress, Not Started, or Completed. |

### 1-13 Progrès réalisés (français)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Progress Made (French) |
| Nom de la zone FR | Progrès réalisés (français) |
| ID | progress_fr |
| Description EN | Describes any progress made |
| Description FR | Décrit les progrès réalisés |
| Obligation EN | Optional |
...
# Profil des éléments de données: Proactive Publication - Contracts over $10,000
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | C-2017-2018-Q1-00170 |

### 1-2 Numéro d’identification d’approvisionnement

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Procurement Identification Number |
| Nom de la zone FR | Numéro d’identification d’approvisionnement |
| ID | procurement_id |
...
| Exemple de valeur | 3000638243 |

### 1-3 Nom du fournisseur

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Vendor Name |
| Nom de la zone FR | Nom du fournisseur |
| ID | vendor_name |
...
| Validation EN | Mandatory for contracts after 2019-01-01 |
| Validation FR | Obligatoire pour les marchés conclus après le 2019-01-01 |
| Exemple de valeur | Company XYZ inc |

### 1-4 Code postal du fournisseur

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Vendor Postal Code |
| Nom de la zone FR | Code postal du fournisseur |
...
| Exemple de valeur | A1A |

### 1-5 Nom de l’acheteur

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Buyer Name |
| Nom de la zone FR | Nom de l’acheteur |
| ID | buyer_name |
...
| Exemple de valeur | John Doe |

### 1-6 Date du contrat

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Contract Date |
| Nom de la zone FR | Date du contrat |
| ID | contract_date |
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | 2017-09-15 |

### 1-7 Code d’article économique

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Economic Object Code |
| Nom de la zone FR | Code d’article économique |
...
| Exemple de valeur | 460 |

### 1-8 Description du travail Anglais

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Description of Work English |
| Nom de la zone FR | Description du travail Anglais |
| ID | description_en |
...
| Validation EN | Mandatory for contracts after 2019-01-01 |
| Validation FR | Obligatoire pour les marchés conclus après le 2019-01-01 |
| Exemple de valeur | Protection services |

### 1-9 Description du travail Français

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Description of Work French |
| Nom de la zone FR | Description du travail Français |
| ID | description_fr |
| Description EN | It is recommended that this field be populated with the economic object code’s text description as listed in the government-wide chart of accounts ( http://www.tpsgc-pwgsc.gc.ca/recgen/pceaf-gwcoa/index-eng.html ). For standing offers and supply arrangement agreements, this field may be populated with the commodity code’s text description used by the federal government for procurement activities. |
| Description FR | Il est recommandé de saisir dans ce champ le texte de description du code d’article économique figurant dans le plan comptable à l’échelle de l’administration fédérale ( http://www.tpsgc-pwgsc.gc.ca/recgen/pceaf-gwcoa/index-fra.html ). Pour les offres à commande et les arrangements en matière d’approvisionnement, ce champ peut comprendre une description du code de produit utilisée par le gouvernement fédéral pour les activités relatives à l’approvisionnement. |
| Obligation EN | Optional |
...
| Validation EN | Mandatory for contracts after 2019-01-01 |
| Validation FR | Obligatoire pour les marchés conclus après le 2019-01-01 |
| Exemple de valeur | Services de protection |

### 1-10 Date de début du contrat

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Contract Period Start Date |
| Nom de la zone FR | Date de début du contrat |
...
| Exemple de valeur | 2017-08-15 |

### 1-11 Date de clôture du contrat ou Date de livraison

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Contract Period End Date or Delivery Date |
| Nom de la zone FR | Date de clôture du contrat ou Date de livraison |
| ID | delivery_date |
...
### 1-12 Valeur totale du contrat

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Total Contract Value |
| Nom de la zone FR | Valeur totale du contrat |
| ID | contract_value |
...
### 1-13 Valeur d'origine du contrat

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Original Contract Value |
| Nom de la zone FR | Valeur d'origine du contrat |
| ID | original_value |
...
### 1-14 Valeur de modification

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Contract Amendment Value |
| Nom de la zone FR | Valeur de modification |
| ID | amendment_value |
...
| Exemple de valeur | 100000 |

### 1-15 Commentaires en anglais
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | This contract was omitted from a previous public disclosure. |

### 1-16 Commentaires en français
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | Ce marché a été omis dans une divulgation publique précédente. |

### 1-17 Commentaires additionnels en anglais

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Additional Comments English |
| Nom de la zone FR | Commentaires additionnels en anglais |
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | 10-Months subscription to Altmetric Explorer for Institutions |

### 1-18 Commentaires additionnels en français

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Additional Comments French |
| Nom de la zone FR | Commentaires additionnels en français |
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | Abonnement de 10 mois à Altmetric Explorer for Institutions |
...
| Nom de la zone FR | Type d’accord |
...
### 1-20 Accord commercial

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Trade Agreement |
| Nom de la zone FR | Accord commercial |
| ID | trade_agreement |
...
### 1-21 Entente sur les revendications territoriales globales

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Comprehensive Land Claims Agreement |
| Nom de la zone FR | Entente sur les revendications territoriales globales |
| ID | land_claims |
...
### 1-22 Type de produit

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Commodity Type |
| Nom de la zone FR | Type de produit |
| ID | commodity_type |
...
### 1-23 Code de produit

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Commodity Code |
| Nom de la zone FR | Code de produit |
| ID | commodity_code |
...
| Exemple de valeur | K105 |

### 1-24 Pays du fournisseur

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Country of Vendor |
| Nom de la zone FR | Pays du fournisseur |
...
### 1-25 Méthode d’invitation à soumissionner

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Solicitation Procedure |
| Nom de la zone FR | Méthode d’invitation à soumissionner |
...
### 1-26 Raisons justifiant le recours à l’appel d’offres limité

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Limited Tendering Reason |
| Nom de la zone FR | Raisons justifiant le recours à l’appel d’offres limité |
...
### 1-27 Exceptions et exclusions applicables aux accords commerciaux

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Trade Agreement Exceptions and Exclusions |
| Nom de la zone FR | Exceptions et exclusions applicables aux accords commerciaux |
...
### 1-28 Stratégie d’approvisionnement auprès des entreprises autochtones

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Procurement Strategy for Indigenous Business |
| Nom de la zone FR | Stratégie d’approvisionnement auprès des entreprises autochtones |
...
### 1-29 Entreprises autochtones excluant le marché réservé en vertu de la SAEA (anciennement Indicateur d’incidence de la SAEA)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Indigenous Business excluding PSIB (formerly PSAB incidental indicator) |
| Nom de la zone FR | Entreprises autochtones excluant le marché réservé en vertu de la SAEA (anciennement Indicateur d’incidence de la SAEA) |
...
### 1-30 Indicateur de propriété intellectuelle

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Intellectual Property Indicator |
| Nom de la zone FR | Indicateur de propriété intellectuelle |
...
### 1-31 Potentiel d'exploitation commerciale

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Potential for Commercial Exploitation |
| Nom de la zone FR | Potentiel d'exploitation commerciale |
...
### 1-32 Ancien fonctionnaire recevant une pension en vertu de la LPFP

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Former Public Servant in receipt of a PSSA pension |
| Nom de la zone FR | Ancien fonctionnaire recevant une pension en vertu de la LPFP |
...
### 1-33 Entité contractante

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Contracting Entity |
| Nom de la zone FR | Entité contractante |
...
### 1-34 Numéro de l’offre à commandes

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Standing Offer or Supply Arrangement Number |
| Nom de la zone FR | Numéro de l’offre à commandes |
...
| Exemple de valeur | EN578-160553/001/ZL |

### 1-35 Type d’instrument

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Instrument Type |
| Nom de la zone FR | Type d’instrument |
| ID | instrument_type |
...
### 1-36 Marchés du cabinet du ministre

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Minister's Office Contracts |
| Nom de la zone FR | Marchés du cabinet du ministre |
| ID | ministers_office |
...
### 1-37 Nombre do soumissions

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Number of Bids |
| Nom de la zone FR | Nombre do soumissions |
| ID | number_of_bids |
...
### 1-38 Article 6 – Exceptions au Règlement concernant les marches de l’État

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Section 6 Government Contracts Regulations Exceptions |
| Nom de la zone FR | Article 6 – Exceptions au Règlement concernant les marches de l’État |
...
### 1-39 Critères d’attribution

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Award Criteria |
| Nom de la zone FR | Critères d’attribution |
| ID | award_criteria |
...
### 1-40 Indicateur socioéconomique

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Socio-Economic Indicator |
| Nom de la zone FR | Indicateur socioéconomique |
...
### 1-41 Periode de déclaration

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Reporting Period |
| Nom de la zone FR | Periode de déclaration |
| ID | reporting_period |
...
| Validation EN | Mandatory for contracts after 2019-01-01 |
| Validation FR | Obligatoire pour les marchés conclus après le 2019-01-01 |
| Exemple de valeur | 2016-2017-Q3 |
...
| --- | --- |
| Nom de la zone EN | Reporting Period |
| Nom de la zone FR | Periode de declaration |
| ID | reporting_period |
| Description EN |   |
| Description FR |   |
| Obligation EN | Optional |
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | 2016-2017-Q2 |
...
# Profil des éléments de données: Proactive Publication - Departmental Audit Committee
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | 2018-2019-Q3 |
...
| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Line Number |
| Nom de la zone FR | Numéro de ligne |
| ID | line_number |
...
| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Member’s Name |
| Nom de la zone FR | Nom du membre |
| ID | member_name |
...
### 1-4 Province ou territoire de résidence primaire

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Province or Territory of Primary Residence |
| Nom de la zone FR | Province ou territoire de résidence primaire |
| ID | province |
...
| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Role |
| Nom de la zone FR | Rôle |
| ID | role |
...
### 1-6 Nombre d'heures consacrées à la rencontre (ou aux rencontres)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Number of Hours Spent at Meeting(s) |
| Nom de la zone FR | Nombre d'heures consacrées à la rencontre (ou aux rencontres) |
| ID | meeting_hours |
...
| Validation EN | This field must not be empty |
| Validation FR | Ce champ ne doit pas être vide |
| Exemple de valeur | 7.5 |

### 1-7 Nombre d'heures consacrées à la préparation, le déplacement et/ou à la formation ou à l'orientation

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Number of hours spent on preparation, travel and/or training or orientation |
| Nom de la zone FR | Nombre d'heures consacrées à la préparation, le déplacement et/ou à la formation ou à l'orientation |
| ID | other_hours |
...
### 1-8 Rémunération totale

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Total Remuneration |
| Nom de la zone FR | Rémunération totale |
| ID | remuneration |
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | 2300.0 |

### 1-9 Frais de voyage totaux

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Total Travel Expenses |
| Nom de la zone FR | Frais de voyage totaux |
| ID | travel_expenses |
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | 500.0 |

### 1-10 Notes (Anglais)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Notes (English) |
| Nom de la zone FR | Notes (Anglais) |
| ID | notes_en |
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | The total remuneration includes time spent at meetings, preparation time and travel time. |

### 1-11 Notes (Français)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Notes (French) |
| Nom de la zone FR | Notes (Français) |
| ID | notes_fr |
| Description EN | Any other relevant information (e.g. description of the activities included in the total remuneration, point of origin of a member’s travel, etc.) |
| Description FR | Toute autre information pertinente (par exemple, une description des activités incluses dans la rémunération totale, le point de départ du déplacement d’un membre, etc.) |
| Obligation EN | Optional |
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | La rémunération totale comprend le temps passé en réunions, le temps de préparation et le temps de déplacement. |
...
# Profil des éléments de données: 5th National Action Plan on Open Government Tracker
...
| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Commitments |
| Nom de la zone FR | Engagements |
| ID | commitments |
...
| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Milestones |
| Nom de la zone FR | Jalons |
| ID | milestones |
...
| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Indicators |
| Nom de la zone FR | Indicateurs |
| ID | indicators |
...
### 1-6 Progrès au cours du trimestre précédent (anglais)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Progress during previous quarter (English) |
| Nom de la zone FR | Progrès au cours du trimestre précédent (anglais) |
| ID | progress_en |
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | - Open government learning materials for teachers have been drafted<br>- Initiating call for proposals to find contractor who can ensure materials are presented in a useful format for teachers and educators |

### 1-7 Progrès au cours du trimestre précédent (français)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Progress during previous quarter (French) |
| Nom de la zone FR | Progrès au cours du trimestre précédent (français) |
| ID | progress_fr |
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | - Des matériels d'apprentissage sur le gouvernement ouvert pour les enseignants ont été rédigés<br>- Lancer un appel à propositions pour trouver un contractant capable de garantir que le matériel est présenté dans un format utile pour les enseignants et les éducateurs. |

### 1-8 Preuve de progrès (anglais)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Evidence of progress (English) |
| Nom de la zone FR | Preuve de progrès (anglais) |
| ID | evidence_en |
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | Materials are still being drafted and not yet available publicly |

### 1-9 Preuve de progrès (français)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Evidence of progress (French) |
| Nom de la zone FR | Preuve de progrès (français) |
| ID | evidence_fr |
| Description EN | Any supporting evidence to demonstrate the progress you have made. This could include websites, links to documents, or other information. |
| Description FR | Toute preuve à l'appui pour démontrer les progrès que vous avez accomplis. Cela peut inclure des sites Web, des liens vers des documents ou d'autres informations. |
| Obligation EN | Optional |
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | Le matériel est toujours en cours de rédaction et n'est pas encore disponible publiquement |

### 1-10 Défis (anglais)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Challenges (English) |
| Nom de la zone FR | Défis (anglais) |
| ID | challenges_en |
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | What sorts of open government learning materials would you like to see? Which formats are most useful for learning purposes? |

### 1-11 Défis (français)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Challenges (French) |
| Nom de la zone FR | Défis (français) |
| ID | challenges_fr |
| Description EN | Describe any challenges faced |
| Description FR | Décrivez les défis rencontrés |
| Obligation EN | Optional |
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | Quels types de matériels d'apprentissage du gouvernement ouvert aimeriez-vous voir? Quels formats sont les plus utiles à des fins d'apprentissage? |


---

# Profil des éléments de données: 6th National Action Plan on Open Government Tracker
...
### 1-5 Indicateur (anglais)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Indicator (English) |
| Nom de la zone FR | Indicateur (anglais) |
| ID | indicator_en |
...
### 1-6 Indicateur (français)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Indicator (French) |
| Nom de la zone FR | Indicateur (français) |
| ID | indicator_fr |
...
### 1-7 Date limite de l'indicateur (anglais)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Indicator Deadline (English) |
| Nom de la zone FR | Date limite de l'indicateur (anglais) |
...
### 1-8 Date limite de l'indicateur (français)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Indicator Deadline (French) |
| Nom de la zone FR | Date limite de l'indicateur (français) |
...
### 1-9 Ministère responsable

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Indicator Lead Department |
| Nom de la zone FR | Ministère responsable |
...
### 1-11 Progrès au cours du  période de déclaration (anglais)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Progress during reporting period (English) |
| Nom de la zone FR | Progrès au cours du  période de déclaration (anglais) |
| ID | progress_en |
...
### 1-12 Progrès au cours du période de déclaration (français)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Progress during reporting period (French) |
| Nom de la zone FR | Progrès au cours du période de déclaration (français) |
| ID | progress_fr |
...
### 1-13 Preuve de progrès (anglais)
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | Materials are drafted and posted at [link] |

### 1-14 Preuve de progrès (français)
...
| Validation EN |   |
| Validation FR |   |
| Exemple de valeur | Les documents sont rédigés et publiés sur [link] |
...
| Exemple de valeur | - Change of funding<br>- Lack of resources |
...
| Validation EN | Required if "Status" is "Limited progress" or "Not started" |
| Validation FR | Obligatoire si « État » est « Progrès limité » ou « Pas commencé ». |
| Exemple de valeur | - Changement de financement<br>- Manque de ressources |


---

# Profil des éléments de données: Proactive Publication - Question Period Notes
...
| Validation EN | This field must not be empty |
| Validation FR | Ce champ ne doit pas être vide |
| Exemple de valeur | DND-2019-QP-00001 |
...
| Validation EN | This field must not be empty |
| Validation FR | Ce champ ne doit pas être vide |
| Exemple de valeur | Bill C-58 (Access to Information Reform) |
...
| Validation EN | This field must not be empty |
| Validation FR | Ce champ ne doit pas être vide |
| Exemple de valeur | Projet de loi C-58 (réforme de l'accès à l'information) |

### 1-4 Titre du ministre
...
### 1-5 Enjeu ou question (anglais)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Issue/Question (English) |
| Nom de la zone FR | Enjeu ou question (anglais) |
| ID | question_en |
...
| Validation EN | None |
| Validation FR | None |
| Exemple de valeur | What is the Government doing to reform the Access to Information Act (Bill C-58)? |

### 1-6 Enjeu ou question (français)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Issue/Question (French) |
| Nom de la zone FR | Enjeu ou question (français) |
| ID | question_fr |
...
| Validation EN | None |
| Validation FR | None |
| Exemple de valeur | Que fait le gouvernement pour réformer la Loi sur l'accès à l'information (projet de loi C-58)? |

### 1-7 Date de fourniture au bureau du minister

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Date Provided to the Minister's Office |
| Nom de la zone FR | Date de fourniture au bureau du minister |
| ID | date_received |
...
### 1-8 Réponse suggérée (anglais)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Suggested Response (English) |
| Nom de la zone FR | Réponse suggérée (anglais) |
| ID | response_en |
...
| Validation EN | This field must not be empty |
| Validation FR | Ce champ ne doit pas être vide |
| Exemple de valeur | * Bill C-58 contains the first significant amendments to the Access to Information Act since it was introduced over three decades ago.<br>* This Bill is the first phase of a two-step approach to update access to information. The targeted changes will be followed by a full review of the Act in Phase II, to begin within one year of royal assent.<br>* The Government thanks the members of the Senate Committee on Legal and Constitutional Affairs for their careful review of Bill C-58. |

### 1-9 Réponse suggérée (français)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Suggested Response (French) |
| Nom de la zone FR | Réponse suggérée (français) |
| ID | response_fr |
...
| Validation EN | This field must not be empty |
| Validation FR | Ce champ ne doit pas être vide |
| Exemple de valeur | Government of Canada institutions subject to the [Access to Information Act](http://laws-lois.justice.gc.ca/eng/acts/a-1/) (ATIA) are required to post summaries of processed ATI requests. |

### 1-11 Contexte (français)

| Attribut | Description de l’attribut |
| --- | --- |
| Nom de la zone EN | Background (French) |
| Nom de la zone FR | Contexte (français) |
| ID | background_fr |
...
| Validation EN | This field must not be empty |
| Validation FR | Ce champ ne doit pas être vide |
| Exemple de valeur | Les institutions du gouvernement du Canada visées par la [Loi sur l’accès à l’information](http://laws-lois.justice.gc.ca/fra/lois/a-1/) (LAI) sont tenues de publier les sommaires des demandes d’accès à l’information qu’elles ont traitées. |

### 1-12 Renseignements supplémentaires (anglais)
...
| Validation EN | None |
| Validation FR | None |
| Exemple de valeur | The Government will continue to work with the Information Commissioner, parliamentarians, and other stakeholders to further strengthen government openness and transparency. |

### 1-13 Renseignements supplémentaires (français)
